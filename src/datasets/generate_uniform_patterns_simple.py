...
def generate_uniform_patterns_dataset_simple(length=99, num_pairs=4, seed=42):
    """
...
def main():
    ...
    print("=" * 70)
    print("UNIFORM PATTERNS DATASET GENERATOR (SIMPLE)")
    print("=" * 70)
    
    try:
        # Generate the dataset
        grids, shapes, program_ids = generate_uniform_patterns_dataset_simple(
            length=LENGTH, 
            num_pairs=NUM_PAIRS, 
            seed=SEED
        )
